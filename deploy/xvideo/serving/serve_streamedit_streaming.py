...
from xvideo.serving.streamedit_streaming import (
    StreamEditRuntime,
    StreamingSettings,
    _module_device,
)
...
def create_app(args: argparse.Namespace) -> FastAPI:
    ...
    async def download_last(rec: str = "") -> Response:
        ...
        download_name = f"streamedit_{base.name}.mp4"
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Serve StreamEdit online v2v streaming inference.")
    ...
    parser.add_argument("--uplink-codec", choices=["auto", "mjpeg"],
                        default=os.environ.get("STREAMEDIT_UPLINK_CODEC", "auto"),
    ...
    parser.add_argument("--downlink-codec", choices=["auto", "mjpeg"],
                        default=os.environ.get("STREAMEDIT_DOWNLINK_CODEC", "auto"),
...
def main() -> None:
    ...
    args = parse_args()
    # STREAMEDIT_VRAM_CAP_GB (testing): cap the allocator to emulate a smaller card.
