...
DIT_CKPT="${STREAMEDIT_DIT_CKPT:-$CKPT_ROOT/editor/model.pth}"
VAE_CKPT="${STREAMEDIT_VAE_CKPT:-$CKPT_ROOT/editor/vae}"
TE_CKPT="${STREAMEDIT_TEXT_ENCODER_CKPT:-$CKPT_ROOT/text_encoder}"
